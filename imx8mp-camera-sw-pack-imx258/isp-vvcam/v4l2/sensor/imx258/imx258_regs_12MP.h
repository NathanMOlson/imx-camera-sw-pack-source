 ...
 *****************************************************************************/
#ifndef _VVCAM_IMX258_REGS_12MP_H_
#define _VVCAM_IMX258_REGS_12MP_H_

#include "vvsensor.h"

/* 4096x3072@30fps RAW10 */
static struct vvcam_sccb_data_s imx258_init_setting_12MP[] = {
    ...
    { 0x0409,0x38 },        //  DIG_CROP_X_OFFSET
    { 0x040A,0x00 },        //  DIG_CROP_Y_OFFSET
    { 0x040B,0x00 },        //  DIG_CROP_Y_OFFSET
    { 0x040C,0x10 },        //  DIG_CROP_IMAGE_WIDTH
    { 0x040D,0x00 },        //  DIG_CROP_IMAGE_WIDTH
    { 0x040E,0x0C },        //  DIG_CROP_IMAGE_HEIGHT
    { 0x040F,0x00 },        //  DIG_CROP_IMAGE_HEIGHT
    ...
    { 0x0202,0x07 },        //  COARSE_INTEG_TIME
    { 0x0203,0x4F },        //  COARSE_INTEG_TIME
    { 0x0204,0x01 },        //  ANA_GAIN_GLOBAL
    { 0x0205,0x5A },        //  ANA_GAIN_GLOBAL
