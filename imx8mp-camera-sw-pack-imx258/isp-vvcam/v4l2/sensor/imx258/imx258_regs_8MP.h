 ...
 *****************************************************************************/
#ifndef _VVCAM_IMX258_REGS_8MP_H_
#define _VVCAM_IMX258_REGS_8MP_H_

#include "vvsensor.h"

/* 3840x2160@30fps RAW10 */
static struct vvcam_sccb_data_s imx258_init_setting_8MP[] = {
    ...
    { 0x040E,0x08 },        //  DIG_CROP_IMAGE_HEIGHT
    { 0x040F,0x70 },        //  DIG_CROP_IMAGE_HEIGHT
    { 0x3038,0x00 },        //  SCALE_MODE_EXT
    { 0x303A,0x00 },        //  SCALE_M_EXT
    { 0x303B,0x10 },        //  SCALE_M_EXT
    { 0x300D,0x00 },        //  FORCE_FD_SUM
    { 0x034C,0x0F },        //  X_OUT_SIZE
    { 0x034D,0x00 },        //  X_OUT_SIZE
    { 0x034E,0x08 },        //  Y_OUT_SIZE
    { 0x034F,0x70 },        //  Y_OUT_SIZE
