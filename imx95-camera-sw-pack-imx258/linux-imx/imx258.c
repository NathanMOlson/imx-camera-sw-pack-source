...
static ssize_t imx258_debugfs_read_gain(struct file *file, char __user *user_buf,
...
static ssize_t imx258_debugfs_read_exposure(struct file *file, char __user *user_buf,
                                        size_t count, loff_t *ppos)
{
    struct imx258 *imx258 = file->private_data;
    char buf[32];
...
static int imx258_probe(struct i2c_client *client)
{
	...
	imx258->rst_gpio = devm_gpiod_get_optional(&client->dev, "reset", GPIOD_OUT_HIGH);
	...
	debugfs_create_file("analog_gain", 0444, imx258->debugfs_dir, imx258, &imx258_readgain_fops);
	debugfs_create_file("expsoure", 0444, imx258->debugfs_dir, imx258, &imx258_readexposure_fops);
